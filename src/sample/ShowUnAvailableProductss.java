...
public class ShowUnAvailableProductss {
    @FXML
    ...
    public void setTable() {
        ...
        unAvailableProducts.getColumns().addAll(goodName, goodAmount, goodBuyPrice, goodSellPrice , goodCode);
    }

    public void showUnAvailableProducts(ActionEvent event) {
        ...
        stage.setTitle("Unavailable Products");
